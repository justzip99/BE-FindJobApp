...
export class Gen1727861883580 implements MigrationInterface {
    name = 'Gen1727861883580'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userName\` varchar(255) NOT NULL DEFAULT '', \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`skill\` varchar(255) NULL, \`education\` varchar(255) NULL, \`experience\` varchar(255) NULL, \`language\` varchar(255) NULL, \`resume\` varchar(255) NULL, \`avatarURL\` varchar(255) NULL, \`balance\` int NOT NULL DEFAULT '0', UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
