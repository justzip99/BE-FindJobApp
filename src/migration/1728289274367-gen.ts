...
export class Gen1728289274367 implements MigrationInterface {
    name = 'Gen1728289274367'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`posts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`job_position\` varchar(255) NOT NULL DEFAULT '', \`location\` json NULL, \`datePost\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`description\` varchar(1000) NOT NULL DEFAULT '', \`salary\` int NOT NULL DEFAULT '0', \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
