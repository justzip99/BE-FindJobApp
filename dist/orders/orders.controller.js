...
const customerorder_dto_1 = require("./customerorder.dto");
let OrdersController = class OrdersController {
    constructor(ordersService) {
        this.ordersService = ordersService;
    }
    addOrder(orderInfo, id) {
        return this.ordersService.addOrder(orderInfo, id);
    }
    updateOrder(orderInfo, id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [customerorder_dto_1.CustomerOrder, Number]),
